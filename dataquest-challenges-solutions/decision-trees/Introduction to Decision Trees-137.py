...
print(entropy)
c_0 = len(income[income["high_income"] == 0])
c_1 = len(income[income["high_income"] == 1])
t_c = len(income)
income_entropy = -(c_0/t_c * math.log(c_0/t_c, 2) + c_1/t_c * math.log(c_1/t_c, 2))
