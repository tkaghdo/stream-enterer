...
pred_1 = clf.predict(test[columns])
pred_2 = clf2.predict(test[columns])

auc_1 = roc_auc_score(test["high_income"],pred_1)
auc_2 = roc_auc_score(test["high_income"],pred_2)
print(auc_1)
print(auc_2)
...
pred2 = clf.predict(test[columns])

print(roc_auc_score(train["high_income"], pred))
print(roc_auc_score(test["high_income"], pred2))