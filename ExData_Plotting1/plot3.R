...
plot(data_df_df$DateTime, data_df_df$Sub_metering_1, type="l", xlab="", ylab="Energy sub metering")
lines(data_df_df$DateTime, data_df_df$Sub_metering_2, col="red")
lines(data_df_df$DateTime, data_df_df$Sub_metering_3, col="blue")
